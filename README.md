...
Amphibians app is a demo app that shows amphibians and its details. The data is stored on a Web server
...
<p align="center">
  <img src="./asset-docs/demo.png" width="350px" alt="Screenshot displaying the amphibians photos list screen.">
</p>
